				...
				this.mGroupFunctions = {
					mat: function (oContext) {
						...
						if (name === cmat) {
							...
							return {
								key: name,
								text: name + Array(11).fill('\xa0').join('') + odnc + Array(7).fill('\xa0').join('') + odgc + Array(5).fill('\xa0').join('') + "(Father Material)" 
									// renderWhitespace:true
							};
						...
						// }
							...
							return {
								key: name,
								text: name + Array(11).fill('\xa0').join('') + net + Array(7).fill('\xa0').join('') + gro
									// renderWhitespace:true
							};
